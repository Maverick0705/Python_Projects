...
Label(Top_frame,text = "CONVERT TEXT INTO SPEECH", font = "arial 20 bold", bg = "white", fg = "black").place(x=100,y=30)

###########

text_area = Text(root, font= "Roboto 20", bg = "white")
text_area.place(x= 10, y=150,width =500, height =259)
...
gender_combobox = Combobox(root, values = ['Male', 'Female'], font ="arial 14",width=10)
...
save=Button(root, text = "Save",compound=LEFT, image=imageicon2, width=130,bg ="#0F9D58" ,font = "arial 14 bold", command=download)
